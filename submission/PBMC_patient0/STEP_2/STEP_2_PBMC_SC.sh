...
nextflow ../../../workflow/main.nf \
    ...
    --annotation "../../../cDNA_pipeline/submission/PBMC_patien0/STEP_3/results/PBMC_rebasecalled_bulk_discovery_FEB_26_2025_with_contamination/bambu_discovery/extended_annotations.gtf" \
