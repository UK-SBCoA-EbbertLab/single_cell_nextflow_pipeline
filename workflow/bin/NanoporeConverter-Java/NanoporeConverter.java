...
public class NanoporeConverter {
    ...
    public static void main(String[] args) {
        ...
        try {
            convertNanopore(sourceDir, outputDir);
        } catch (IOException e) {
            System.err.println("An error occurred during the conversion process: " + e.getMessage());
        }
    }
     ...
     */
    public static void convertNanopore(String sourceDir, String outputDir) throws IOException {
				    ...
				    found = true;
                        ...
                        if (found) {
                            ...
                            if (line.length() > r2StartPos + 20) {
                                r2Sequence = line.substring(r2StartPos).trim();
                            } else {
                                skipRead = true;
                            }
                        } else {
                        ...
                        if (!skipRead) {
                            ...
                            String r1Qual = line.substring(r1StartPos, r1EndPos);
    ...
    private static void clearFile(String path) throws IOException {
        try (GZIPOutputStream clear = new GZIPOutputStream(new FileOutputStream(path))) {
